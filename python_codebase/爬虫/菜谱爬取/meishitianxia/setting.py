...
#
# MYSQL
MYSQL_IP = "123.60.183.169"
MYSQL_PORT = 3306
MYSQL_DB = "text_db"
MYSQL_USER_NAME = "text_db"
MYSQL_USER_PASS = "text_db./?"
...
REDISDB_IP_PORTS = "123.60.183.169:6379"
REDISDB_USER_PASS = "Fu@Qing.redis"
REDISDB_DB = 2
# # 适用于redis哨兵模式
...
# # 爬虫相关
# # COLLECTOR
COLLECTOR_TASK_COUNT = 12  # 每次获取任务数量，追求速度推荐32
#
# # SPIDER
SPIDER_THREAD_COUNT = 12  # 爬虫并发数，追求速度推荐32
# # 下载时间间隔 单位秒。 支持随机 如 SPIDER_SLEEP_TIME = [2, 5] 则间隔为 2~5秒之间的随机数，包含2和5
SPIDER_SLEEP_TIME = [2, 6]
...
# item入库时间间隔
ITEM_UPLOAD_INTERVAL = 10
# 内存任务队列最大缓存的任务数，默认不限制；仅对AirSpider有效。
# TASK_MAX_CACHED_SIZE = 100
