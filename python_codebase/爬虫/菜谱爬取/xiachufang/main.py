# -*- coding: utf-8 -*-
"""
Created on 2023-05-27 23:13:50
---------
@summary: 爬虫入口
---------
@author: FQCj
...
from spiders import xiachufangitem
...
def crawl_xiachufangUrl():
    """
    Spider爬虫
    """
    spider = xiachufangitem.Xiachufangitem(redis_key="xiachufang:key", thread_count=12)
    spider.start()
...
if __name__ == "__main__":
    parser = ArgumentParser(description="下厨房")

    parser.add_argument(
        "--crawl_xiachufangitem", action="store_true", help="下厨房分类url-下的所有菜品采集爬虫",
        function=crawl_xiachufangUrl
    )
    # parser.add_argument(
